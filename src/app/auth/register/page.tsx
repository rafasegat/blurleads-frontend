...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent): Promise<void> => {
    e.preventDefault();
    setLoading(true);
    console.log('[Register] Attempting email/password registration');
  ...
  const handleGoogleSignIn = async (): Promise<void> => {
    ...
    console.log('[Register] Attempting Google OAuth registration');

    try {
      await signInWithGoogle();
      console.log('[Register] Google OAuth initiated');
    } catch (error: any) {
